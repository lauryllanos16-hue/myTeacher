...
function toggleEditar() {
  ...
  if (editando) {
    ...
    document.getElementById('inputPrecio').value    = document.getElementById('precioTexto').textContent;
    ...
    for (let i = 0; i < selMod.options.length; i++) {
      if (selMod.options[i].text === modalidadActual) { selMod.selectedIndex = i; break; }
    }
